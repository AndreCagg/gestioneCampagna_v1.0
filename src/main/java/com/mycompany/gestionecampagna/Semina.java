 ...
 * @author caggi
 */
public class Semina extends javax.swing.JFrame {
    ...
    private void salvaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_salvaActionPerformed
        ...
        try {
            conn = DriverManager.getConnection(url, user, pass);
            String query = "INSERT INTO " + this.getTipo().toLowerCase() + " (proprieta,campo,data,coltura) VALUES(?,?,?,?)";
            PreparedStatement state = conn.prepareStatement(query);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Semina.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
