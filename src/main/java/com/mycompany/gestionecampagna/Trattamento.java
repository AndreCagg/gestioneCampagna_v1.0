...
public class Trattamento extends javax.swing.JFrame {
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(layout.createSequentialGroup()
                                        ...
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                        .addComponent(prodottotxt, javax.swing.GroupLayout.PREFERRED_SIZE, 170, javax.swing.GroupLayout.PREFERRED_SIZE))
                                    .addGroup(layout.createSequentialGroup()
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        ...
                        .addComponent(prodottotxt, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void salvaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_salvaActionPerformed
        ...
        try {
            conn = DriverManager.getConnection(url, user, pass);
            String query = "INSERT INTO " + this.getTipo().toLowerCase() + " (proprieta,campo,data,coltura,prodotto) VALUES(?,?,?,?,?)";
            PreparedStatement state = conn.prepareStatement(query);
            ...
            state.setString(5, prodottotxt.getText());
            state.executeUpdate();
            conn.close();
        } catch (SQLException sql) {
            //sql.printStackTrace();
    ...
    private void formComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_formComponentShown
        ...
        try {
            conn = DriverManager.getConnection(url, user, pass);
            String query = "SELECT prodotto FROM trattamento WHERE id=" + this.getId();
            Statement state = conn.createStatement();
            ResultSet ris = state.executeQuery(query);
            while (ris.next()) {
                prodottotxt.setText(ris.getString("prodotto"));
            }
            conn.close();
        } catch (SQLException sql) {
            err.setText("DB error. error code " + sql.getErrorCode() + " sqlstate " + sql.getSQLState());
        }
        prodottotxt.setEditable(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Trattamento.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Trattamento().setVisible(true);
            }
        });
    }
